            ...
            <h1 className="popup__title popup__title_type_auth account__title">Регистрация</h1>
                <form className="account__form">
                    <div className="account__input-field">
                        <input className="account__input" id="registration-email" name="registration-email" type="email" value={email} required placeholder="Email" onChange={handleEmailChange}/>
                        <span className="account__input-error" id="error-name"></span>
                    </div>
                    <div className="account__input-field">
                        <input className="account__input" id="registration-password" name="registration-password" type="text" minLength='5' maxLength='15' value={password} onChange={handlePasswordChange} required placeholder="Пароль" />
                        <span className="account__input-error" id="error-name"></span>
                    </div>
